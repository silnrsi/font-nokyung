...
The full source code for the Nokyung font is available on [Github](https://github.com/silnrsi/font-nokyung)
...
- fontmake -m source/Nokyung-VF.designspace -o variable
